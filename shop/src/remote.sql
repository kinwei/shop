/*删除商城数据库,如果存在*/
drop database if exists sq_kinwei;
/*创建数据库,并设置编码*/
create database sq_kinwei default character set utf8;
...
/* 修改自动增长的初始值 */
ALTER TABLE forder AUTO_INCREMENT = 123399325;
...
/* 用户测试用例 */
INSERT INTO user (login,name,pass,sex,phone,email) VALUES ('user','小刚','user','男','13203168780','jinwei.sg@163.com');
